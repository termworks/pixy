__pixy_prompt_command() {
  ...
  PS1="$(command pixy render prompt.left --target bash --palette --set status="$pixy_status" --set duration_ms="$pixy_duration" --set jobs="$pixy_jobs" --set language="${PIXY_LANGUAGE:-}" --set vimode="${PIXY_VIMODE:-}")"
}
